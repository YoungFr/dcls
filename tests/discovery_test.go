...
import (
	...
	"github.com/youngfr/dcls/internal/discovery"
)
...
func TestMembership(t *testing.T) {
	...
	require.Eventually(
		t,
		func() bool {
			return len(handler.joins) == 2 && len(m[0].Members()) == 3 &&
				serf.StatusLeft == m[0].Members()[2].Status && len(handler.leaves) == 1
		},
		3*time.Second,
		250*time.Millisecond)
...
var _ discovery.Handler = &handler{}
